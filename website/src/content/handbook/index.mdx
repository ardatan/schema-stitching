import { HandbookBanner } from '../../components/handbook-banner'
...
- **[Federation Supergraph](/handbook/other-integrations/federation-supergraph)**
  - Consume a Federation Supergraph SDL in Schema Stitching
  - No conversion needed from Federation SDL to Stitching SDL

- **[Federation to Stitching SDL](/handbook/other-integrations/federation-to-stitching-sdl)**
