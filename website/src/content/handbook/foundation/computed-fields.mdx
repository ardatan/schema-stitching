...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/computed-fields?codemirror=1&fontsize=14&initialpath=/graphql&file=/src/gateway.ts&theme=dark"
