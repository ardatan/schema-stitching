...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/graphql-upload?codemirror=1&fontsize=14&initialpath=/graphql&theme=dark"
