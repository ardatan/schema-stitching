...
In this example query, `readFile` of **Upload Files** subservice is called to read the file from the disk and `resized` of **Resize Images** subservice is called to resize the image.
...
# output
# {"data":{"uploadFile":{"filename":"file.txt","mimetype":"text/plain","text":"hello upload\n"}}}
```