...
As you get the hang of schema stitching, you may find that [Federation services](https://the-guild.dev/graphql/hive/federation) are fairly complex
...
durable. While [Federation](https://the-guild.dev/graphql/hive/federation) automates service bindings at the cost of tightly-coupled complexity,
