...
- See [versioning schema releases](../versioning-schema-releases) for more ideas on versioning and
  reloading.
...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/hot-schema-reloading?codemirror=1&fontsize=14&initialpath=/graphql&theme=dark"
...
See [versioning schema releases](../versioning-schema-releases) for a deeper exploration of
hot-reloads that fetch from a versioned schema registry.
