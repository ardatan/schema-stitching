...
- **[Persistent connection via WebSockets](/handbook/architecture/persistent-connection)**
  ...
  - Creating a [GraphQL over WebSocket Protocol](https://github.com/enisdenjo/graphql-ws/blob/master/PROTOCOL.md) executor for the persistent connection to the services.
...
- **[Subservice languages](/handbook/other-integrations/subservice-languages)**
  ...
  - **[JavaScript](/handbook/other-integrations/subservice-languages/javascript)** schemas created with:
