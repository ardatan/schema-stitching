...
- See [array-batched type merging](/handbook/type-merging-arrays) to improve the performance of these basic patterns.
- See [stitching directives SDL](/handbook/stitching-directives-sdl) to write this merge configuration as schema directives.
