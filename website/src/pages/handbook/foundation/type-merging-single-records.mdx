...
[merged arrays chapter](../type-merging-arrays). However&mdash;it's still useful when interacting
with services beyond our control, and it's an excellent way to observe the behavior of
