...
This example demonstrates customizing merged type resolvers, expanding upon the [type resolvers documentation](/docs/approaches/type-merging#type-resolvers).
...
1. [Transform the schema](/docs/getting-started/dding-transforms) (and its returned data) into a shape that stitching expects.
2. Write a [custom merge resolver](/docs/approaches/type-merging#type-resolvers) that acts as an adaptor for this service.
...
> You can also see the project on GitHub [here](https://github.com/ardatan/schema-stitching/tree/master/examples/custom-merge-resolvers).
