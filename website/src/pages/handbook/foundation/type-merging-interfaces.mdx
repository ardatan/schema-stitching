...
This example explores setting up a GraphQL interface that spans across service boundaries, as described in the [merged interfaces documentation](/docs/approaches/type-merging#merged-interfaces). This is an easily overlooked feature made possible by the flexibility of type merging.
...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/type-merging-interfaces?fontsize=14&hidenavigation=1&theme=dark"
...
> You can also see the project on GitHub [here](https://github.com/ardatan/schema-stitching/tree/master/examples/type-merging-interfaces).
