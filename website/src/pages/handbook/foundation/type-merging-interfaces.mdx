...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/type-merging-interfaces?codemirror=1&fontsize=14&initialpath=/graphql&file=/src/gateway.ts&theme=dark"
