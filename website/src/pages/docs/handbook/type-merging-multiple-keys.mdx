...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/type-merging-multiple-keys?fontsize=14&hidenavigation=1&theme=dark"
...
For simplicity, all subservices in this example are run locally by the gateway server. You could easily break out any subservice into a standalone remote server following the [combining local and remote schemas](/docs/handbook/combining-local-and-remote-schemas) example.
