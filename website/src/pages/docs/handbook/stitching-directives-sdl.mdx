...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/stitching-directives-sdl?fontsize=14&hidenavigation=1&theme=dark"
...
> You can also see the project on GitHub [here](https://github.com/ardatan/schema-stitching/tree/master/examples/stitching-directives-sdl).
