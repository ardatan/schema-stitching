...
This example explores the core techniques for merging typed objects using array queries, covering most of the topics discussed in [batched merging documentation](/docs/approaches/type-merging#batching).

This example focuses on [array batching](/docs/handbook/appendices/batching-arrays-and-queries#what-is-array-batching)&mdash;meaning that all records accessed during a round of delegation are batched together and loaded as an array. This technique greatly reduces the execution overhead of [single-record merges](../02-single-record-type-merging), and can be further optimized by enabling [query batching](/docs/handbook/appendices/batching-arrays-and-queries#what-is-query-batching). This array-batched strategy is prefereable to single-record merges and should be used whenever possible.

**This example demonstrates:**

- [One-way type merging](/docs/approaches/type-merging#basic-example) using array queries.
- [Multi-directional type merging](/docs/approaches/type-merging#unidirectional-merges) using array queries.
- Handling array errors.
- Nullability & error remapping.

**Related examples:**

- See [single-record type merging](/docs/handbook/type-merging-single-records) for additional information on basic merge patterns.
...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/type-merging-arrays?fontsize=14&hidenavigation=1&theme=dark"
...
> You can also see the project on GitHub [here](https://github.com/ardatan/schema-stitching/tree/master/examples/type-merging-arrays).
