...
sidebarTitle: Public and private APIs
---
...
<iframe
  src="https://codesandbox.io/embed/github/ardatan/schema-stitching/tree/master/examples/public-and-private-apis?codemirror=1&fontsize=14&initialpath=/graphql&file=/src/gateway.ts&theme=dark"
